...
@push('styles')
    <style>
        #footersociallink-table td.reorder-handle { cursor: grab; }
    </style>
@endpush
...
@push('scripts')
    <script>
        $(function () {
            $('#footersociallink-table').on('init.dt', function () {
                var tbody = document.querySelector('#footersociallink-table tbody');
                ...
                Sortable.create(tbody, {
                    ...
                    onEnd: function () {
                        ...
                        $.post("{{ route('admin.footer-social.reorder') }}", { order: order })
                            .done(function () {
                                toastr.success('Order updated!', 'Success');
                                window.LaravelDataTables['footersociallink-table'].ajax.reload(null, false);
                            })
                            .fail(function () {
