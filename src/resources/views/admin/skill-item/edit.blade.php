                    ...
                    <form action="{{route('admin.skill-item.update', $skill->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <input type="text" name="name[en]" class="form-control mb-2" value="{{$skill->getTranslation('name','en',false)}}">
                                <small class="text-muted">Español</small>
                                <input type="text" name="name[es]" class="form-control mb-2" value="{{$skill->getTranslation('name','es',false)}}">
                                <small class="text-muted">Português</small>
                                <input type="text" name="name[pt]" class="form-control" value="{{$skill->getTranslation('name','pt',false)}}">
                            </div>
                        </div>
