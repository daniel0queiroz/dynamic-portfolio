...
@push('styles')
    <style>
        #skillitem-table td.reorder-handle { cursor: grab; }
    </style>
@endpush
...
@push('scripts')
    <script>
        $(function () {
            $('#skillitem-table').on('init.dt', function () {
                var tbody = document.querySelector('#skillitem-table tbody');
                ...
                Sortable.create(tbody, {
                    ...
                    onEnd: function () {
                        ...
                        $.post("{{ route('admin.skill-item.reorder') }}", { order: order })
                            .done(function () {
                                toastr.success('Order updated!', 'Success');
                                window.LaravelDataTables['skillitem-table'].ajax.reload(null, false);
                            })
                            .fail(function () {
