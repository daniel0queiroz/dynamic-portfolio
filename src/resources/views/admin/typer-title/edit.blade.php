                    ...
                    <form action="{{route('admin.typer-title.update', $title->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                <input type="text" name="title[en]" class="form-control mb-2" value="{{$title->getTranslation('title','en',false)}}">
                                <small class="text-muted">Español</small>
                                <input type="text" name="title[es]" class="form-control mb-2" value="{{$title->getTranslation('title','es',false)}}">
                                <small class="text-muted">Português</small>
                                <input type="text" name="title[pt]" class="form-control" value="{{$title->getTranslation('title','pt',false)}}">
                            </div>
                        </div>
