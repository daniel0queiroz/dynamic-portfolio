              ...
              <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('password.email')); ?>" class="needs-validation" novalidate="">
                  ...
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control" name="email" value="<?php echo e(old('email')); ?>" tabindex="1" required autofocus>
...
<?php /**PATH /var/www/src/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>